...
"""
教练视图菜单初始化脚本
使用方式: uv run python add_coach_schedule_menu.py
"""
...
async def execute_sql():
    ...
    # 读取SQL文件
    sql_path = Path(__file__).parent / "add_coach_schedule_menu.sql"
    ...
    try:
        ...
        result = await conn.fetch("""
            ...
            WHERE m1.route_name = 'Badminton' AND m2.route_name = 'BadmintonCoachSchedule'
